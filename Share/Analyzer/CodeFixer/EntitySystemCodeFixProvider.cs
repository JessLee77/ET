...
namespace ET.Analyzer
{
    ...
    public class EntitySystemCodeFixProvider : CodeFixProvider
    {
        ...
        public sealed override async Task RegisterCodeFixesAsync(CodeFixContext context)
        {
            ...
            CodeAction codeAction = CodeAction.Create("Generate Entity System",
        ...
        private static async Task<Document> GenerateEntitySystemAsync(Document document, ClassDeclarationSyntax? classDeclaration,
        ...
        CancellationToken cancellationToken)
        {
            ...
            var newClassDeclaration = classDeclaration.WithMembers(classDeclaration.Members.AddRange(newMembers))
...
""";
        ...
        Document document, CancellationToken cancellationToken)
        {
            if (document.SupportsSyntaxTree)
            {
                ...
                document = await Formatter.FormatAsync(document, SyntaxAnnotation.ElasticAnnotation, cancellationToken: cancellationToken)
                        .ConfigureAwait(false);
            }
